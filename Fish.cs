...
public class Fish : MonoBehaviour
{
    ...
    // called every timestep (independent of frame rate, so will still function
    // if we are training at accelerated game speed)
    ...
    private void Swim()
    {
    	...
    	{
    		// Make sure the fish does not swim past the target
